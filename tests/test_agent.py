...
def agent():
    with patch('hive_agent.agent.OpenAILLM'), \
        ...
        test_agent = HiveAgent(
            ...
            config_path='/Users/Tian/Desktop/hive-agent/hive-agent-py/tests/hive_config_test.toml',
            host='0.0.0.0',
            port=8000,
...
async def test_agent_initialization(agent):
    ...
    assert agent.config_path == '/Users/Tian/Desktop/hive-agent/hive-agent-py/tests/hive_config_test.toml'
